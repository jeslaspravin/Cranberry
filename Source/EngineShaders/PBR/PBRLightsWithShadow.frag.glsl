...
layout(set = 2, binding = 3) uniform sampler2DArray directionalLightCascades;
layout(set = 2, binding = 4) uniform samplerCube pointShadowMaps[8];
layout(set = 2, binding = 5) uniform sampler2D spotLightShadowMaps[8];
