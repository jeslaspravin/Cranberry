...
#define IMG_FORMAT_INFO_PAIR(PixelFormat,RelevantApiFormat,DataSize) { PixelFormat, { RelevantApiFormat, DataSize, #PixelFormat }}
    const std::map<Type, ImageFormatInfo> DATA_FORMAT_TO_API_FORMAT = {
        ...
        IMG_FORMAT_INFO_PAIR(BGR_U8_Norm, VK_FORMAT_B8G8R8_UNORM, 3),
        IMG_FORMAT_INFO_PAIR(BGR_S8_Norm, VK_FORMAT_B8G8R8_SNORM, 3),
        IMG_FORMAT_INFO_PAIR(BGR_U8_Scaled, VK_FORMAT_B8G8R8_USCALED, 3),
        IMG_FORMAT_INFO_PAIR(BGR_S8_Scaled, VK_FORMAT_B8G8R8_SSCALED, 3),
        IMG_FORMAT_INFO_PAIR(BGR_UI8, VK_FORMAT_B8G8R8_UINT, 3),
        IMG_FORMAT_INFO_PAIR(BGR_SI8, VK_FORMAT_B8G8R8_SINT, 3),
        IMG_FORMAT_INFO_PAIR(BGR_U8_SRGB, VK_FORMAT_B8G8R8_SRGB, 3),
        ...
        IMG_FORMAT_INFO_PAIR(ABGR_U8_SrgbPacked, VK_FORMAT_A8B8G8R8_SRGB_PACK32, 4),
        ...
        IMG_FORMAT_INFO_PAIR(BGRA_UI8, VK_FORMAT_B8G8R8A8_UINT, 4),
        IMG_FORMAT_INFO_PAIR(BGRA_SI8, VK_FORMAT_B8G8R8A8_SINT, 4),
        IMG_FORMAT_INFO_PAIR(BGRA_U8_SRGB, VK_FORMAT_B8G8R8A8_SRGB, 4),
        IMG_FORMAT_INFO_PAIR(R_U8_Norm, VK_FORMAT_R8_UNORM , 1),
        IMG_FORMAT_INFO_PAIR(R_S8_Norm, VK_FORMAT_R8_SNORM , 1),
        IMG_FORMAT_INFO_PAIR(R_U8_Scaled, VK_FORMAT_R8_USCALED , 1),
        IMG_FORMAT_INFO_PAIR(R_S8_Scaled, VK_FORMAT_R8_SSCALED , 1),
        IMG_FORMAT_INFO_PAIR(R_UI8,VK_FORMAT_R8_UINT , 1),
        IMG_FORMAT_INFO_PAIR(R_SI8, VK_FORMAT_R8_SINT , 1),
        IMG_FORMAT_INFO_PAIR(R_U8_SRGB, VK_FORMAT_R8_SRGB , 1),
        IMG_FORMAT_INFO_PAIR(RG_U8_Norm, VK_FORMAT_R8G8_UNORM , 2),
        IMG_FORMAT_INFO_PAIR(RG_S8_Norm, VK_FORMAT_R8G8_SNORM , 2),
        IMG_FORMAT_INFO_PAIR(RG_U8_Scaled, VK_FORMAT_R8G8_USCALED , 2),
        IMG_FORMAT_INFO_PAIR(RG_S8_Scaled, VK_FORMAT_R8G8_SSCALED , 2),
        IMG_FORMAT_INFO_PAIR(RG_UI8, VK_FORMAT_R8G8_UINT , 2),
        IMG_FORMAT_INFO_PAIR(RG_SI8, VK_FORMAT_R8G8_SINT , 2),
        IMG_FORMAT_INFO_PAIR(RG_U8_SRGB, VK_FORMAT_R8G8_SRGB , 2),
        IMG_FORMAT_INFO_PAIR(RGB_U8_Norm, VK_FORMAT_R8G8B8_UNORM , 3),
        IMG_FORMAT_INFO_PAIR(RGB_S8_Norm, VK_FORMAT_R8G8B8_SNORM , 3),
        IMG_FORMAT_INFO_PAIR(RGB_U8_Scaled, VK_FORMAT_R8G8B8_USCALED , 3),
        IMG_FORMAT_INFO_PAIR(RGB_S8_Scaled, VK_FORMAT_R8G8B8_SSCALED , 3),
        IMG_FORMAT_INFO_PAIR(RGB_UI8, VK_FORMAT_R8G8B8_UINT , 3),
        IMG_FORMAT_INFO_PAIR(RGB_SI8, VK_FORMAT_R8G8B8_SINT , 3),
        IMG_FORMAT_INFO_PAIR(RGB_U8_SRGB, VK_FORMAT_R8G8B8_SRGB , 3),
        IMG_FORMAT_INFO_PAIR(RGBA_U8_Norm, VK_FORMAT_R8G8B8A8_UNORM, 4),
        IMG_FORMAT_INFO_PAIR(RGBA_S8_Norm, VK_FORMAT_R8G8B8A8_SNORM, 4),
        IMG_FORMAT_INFO_PAIR(RGBA_U8_Scaled, VK_FORMAT_R8G8B8A8_USCALED, 4),
        IMG_FORMAT_INFO_PAIR(RGBA_S8_Scaled, VK_FORMAT_R8G8B8A8_SSCALED, 4),
        IMG_FORMAT_INFO_PAIR(RGBA_UI8, VK_FORMAT_R8G8B8A8_UINT, 4),
        IMG_FORMAT_INFO_PAIR(RGBA_SI8, VK_FORMAT_R8G8B8A8_SINT, 4),
        IMG_FORMAT_INFO_PAIR(RGBA_U8_SRGB, VK_FORMAT_R8G8B8A8_SRGB, 4),
        ...
        IMG_FORMAT_INFO_PAIR(A2BGR10_U32_NormPacked, VK_FORMAT_A2B10G10R10_UNORM_PACK32, 4),
        IMG_FORMAT_INFO_PAIR(A2BGR10_S32_NormPacked, VK_FORMAT_A2B10G10R10_SNORM_PACK32, 4),
        ...
        IMG_FORMAT_INFO_PAIR(A2BGR10_UI32_Packed, VK_FORMAT_A2B10G10R10_UINT_PACK32, 4),
        IMG_FORMAT_INFO_PAIR(A2BGR10_SI32_Packed, VK_FORMAT_A2B10G10R10_SINT_PACK32, 4),
        ...
        IMG_FORMAT_INFO_PAIR(R_UI64, VK_FORMAT_R64_UINT, 8),
        IMG_FORMAT_INFO_PAIR(R_SI64, VK_FORMAT_R64_SINT, 8),
        IMG_FORMAT_INFO_PAIR(R_SF64, VK_FORMAT_R64_SFLOAT, 8),
        IMG_FORMAT_INFO_PAIR(RG_UI64, VK_FORMAT_R64G64_UINT, 16),
        IMG_FORMAT_INFO_PAIR(RG_SI64, VK_FORMAT_R64G64_SINT, 16),
        IMG_FORMAT_INFO_PAIR(RG_SF64, VK_FORMAT_R64G64_SFLOAT, 16),
        IMG_FORMAT_INFO_PAIR(RGB_UI64, VK_FORMAT_R64G64B64_UINT, 24),
        IMG_FORMAT_INFO_PAIR(RGB_SI64, VK_FORMAT_R64G64B64_SINT, 24),
        IMG_FORMAT_INFO_PAIR(RGB_SF64, VK_FORMAT_R64G64B64_SFLOAT, 24),
        IMG_FORMAT_INFO_PAIR(RGBA_UI64, VK_FORMAT_R64G64B64A64_UINT, 32),
        IMG_FORMAT_INFO_PAIR(RGBA_SI64, VK_FORMAT_R64G64B64A64_SINT, 32),
        IMG_FORMAT_INFO_PAIR(RGBA_SF64, VK_FORMAT_R64G64B64A64_SFLOAT, 32),
        ...
        IMG_FORMAT_INFO_PAIR(D24S8_U40_DNorm_SInt, VK_FORMAT_D24_UNORM_S8_UINT, 4)
    };
