...
public:
    ...
    // Matrix should be proper orthogonal matrix, Some non uniform scaled matrices won't create proper transform, In those cases use raw Matrix
    ...
    // Below functions works only for uniform scale for non uniform scale use corresponding *NonUniformScaled
