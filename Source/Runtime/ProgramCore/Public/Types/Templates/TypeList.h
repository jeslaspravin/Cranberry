...
/*
* Creates a typelist which can be used later to convert to variadic type and querying and modification of types are supported as well
* 
* Usages
* 
...
namespace TL
{
    ...
    {
        using type = TypeList<ToType
            , typename ReplaceAll<NextType, ThisType, ToType>::type>;
    };
    ...
    struct ReplaceAll<TypeList<ThisType, NextType>, FromType, ToType>
    {
        using type = TypeList<ThisType
            , typename ReplaceAll<NextType, FromType, ToType>::type>;
    };
    ...
    {
        using type = TypeList<ThisType
            , typename Replace<NextType, FromType, ToType>::type>;
    };
    ...
    {
        using type = TypeList<ThisType
            , typename EraseAll<NextType, EraseType>::type>;
    };
    ...
    {
        using type = TypeList<ThisType
            , typename Erase<NextType, EraseType>::type>;
    };
    ...
    {
        template <typename UserType>
        static void call(UserType* userData) { Callable<ThisType, UserType>{}(userData); DoForEach<NextType, Callable>::call(userData); };
    };
    ...
    // Above example applies the typelist type to CreatFrom which creates a new typelist type which is printed here
    //
