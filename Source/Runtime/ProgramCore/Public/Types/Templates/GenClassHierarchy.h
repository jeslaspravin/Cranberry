...
* Usage
* 
* Here we are printing type info of each types in typelist without writing additional codes and using both runtime and static polymorphisms
* 
* using TestTL = TL::CreateFrom<ExperimentalEnginePBR, Vector2D, Vector3D, Vector4D, Matrix2, Matrix3, Matrix4>::type;
* 
...
* };
* 
* class LinearGenClass : public GenLinearHierarchy<TL::Reverse<TestTL>::type, TestLinearGen, ScatterGenClass>
* {
* public:
...
template <typename TList
    , template <typename Type> typename InheritClassType>
...
class GenScatteredHierarchy<TypeList<ThisType, NextType>, InheritClassType> 
    : public InheritClassType<ThisType>, public GenScatteredHierarchy<NextType, InheritClassType>
{
public:
...
template <
    typename TList
    , template <typename Type, typename BaseType> typename InheritClassType
...
template <
    typename ThisType, typename NextType
    , template <typename Type, typename BaseType> typename InheritClassType
    , typename RootType
>
