...
namespace ColorConst
{
    ...
    PROGRAMCORE_EXPORT const Color Transparent(255, 255, 255, 0);
    PROGRAMCORE_EXPORT const Color WHITE(255, 255, 255, 255);
    PROGRAMCORE_EXPORT const Color GRAY(128, 128, 128, 255);
    PROGRAMCORE_EXPORT const Color BLACK(0, 0, 0, 255);
    PROGRAMCORE_EXPORT const Color RED(255, 0, 0, 255);
    PROGRAMCORE_EXPORT const Color BLUE(0, 0, 255, 255);
    PROGRAMCORE_EXPORT const Color GREEN(0, 255, 0, 255);
}
...
namespace LinearColorConst
{
    ...
    PROGRAMCORE_EXPORT const LinearColor Transparent(1, 1, 1, 0);
    PROGRAMCORE_EXPORT const LinearColor WHITE(1, 1, 1, 1);
    PROGRAMCORE_EXPORT const LinearColor GRAY(0.5, 0.5, 0.5, 1);
    PROGRAMCORE_EXPORT const LinearColor BLACK(0, 0, 0, 1);
    PROGRAMCORE_EXPORT const LinearColor RED(1, 0, 0, 1);
    PROGRAMCORE_EXPORT const LinearColor BLUE(0, 0, 1, 1);
    PROGRAMCORE_EXPORT const LinearColor GREEN(0, 1, 0, 1);
}