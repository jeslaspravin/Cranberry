...
float &Rotation::roll() { return value.x; }

float Rotation::roll() const { return value.x; }

float &Rotation::pitch() { return value.y; }

float Rotation::pitch() const { return value.y; }

float &Rotation::yaw() { return value.z; }
...
Rotation Rotation::floor(const Rotation &value) { return Rotation(glm::floor(value.value)); }

Rotation Rotation::ceil(const Rotation &value) { return Rotation(glm::ceil(value.value)); }
