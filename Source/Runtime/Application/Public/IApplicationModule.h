...
public:
    ...
    virtual DelegateHandle registerOnWindowCreated(AppWindowDelegate::SingleCastDelegateType callback)
        = 0;
    ...
    virtual DelegateHandle registerPreWindowSurfaceUpdate(
        AppWindowDelegate::SingleCastDelegateType callback)
        = 0;
    ...
    virtual DelegateHandle registerOnWindowSurfaceUpdated(
        AppWindowDelegate::SingleCastDelegateType callback)
        = 0;
    ...
    virtual DelegateHandle registerOnWindowDestroyed(AppWindowDelegate::SingleCastDelegateType callback)
        = 0;
    virtual void unregisterOnWindowDestroyed(const DelegateHandle &callbackHandle) = 0;

    // After all windows are destroyed
    virtual DelegateHandle registerAllWindowDestroyed(SimpleDelegate::SingleCastDelegateType callback)
        = 0;
