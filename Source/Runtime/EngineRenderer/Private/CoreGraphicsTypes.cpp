...
const std::map<Type, PixelFormatInfo> DATA_FORMAT_TO_API_FORMAT
    = { IMG_FORMAT_INFO_PAIR(Undefined, 0, MAKE_INITIALIZER(0, 0, 0, 0)),
          ...
          IMG_FORMAT_INFO_PAIR(
              A2RGB10_U32_NormPacked, 4, MAKE_INITIALIZER(10, 10, 10, 2), MAKE_COMPS(B, G, R, A)),
          IMG_FORMAT_INFO_PAIR(
              A2RGB10_S32_NormPacked, 4, MAKE_INITIALIZER(10, 10, 10, 2), MAKE_COMPS(B, G, R, A)),
          IMG_FORMAT_INFO_PAIR(
              A2RGB10_U32_ScaledPacked, 4, MAKE_INITIALIZER(10, 10, 10, 2), MAKE_COMPS(B, G, R, A)),
          IMG_FORMAT_INFO_PAIR(
              A2RGB10_S32_ScaledPacked, 4, MAKE_INITIALIZER(10, 10, 10, 2), MAKE_COMPS(B, G, R, A)),
          IMG_FORMAT_INFO_PAIR(
              A2RGB10_UI32_Packed, 4, MAKE_INITIALIZER(10, 10, 10, 2), MAKE_COMPS(B, G, R, A)),
          IMG_FORMAT_INFO_PAIR(
              A2RGB10_SI32_Packed, 4, MAKE_INITIALIZER(10, 10, 10, 2), MAKE_COMPS(B, G, R, A)),
...
const ShaderStageInfo *getShaderStageInfo(EShaderStage::Type shaderStage)
{
    ...
    static const std::map<Type, ShaderStageInfo> shaderStageToApiStage
        = { SHADER_STAGE_TO_API_PAIR(Compute, "mainComp", "comp"),
              SHADER_STAGE_TO_API_PAIR(Vertex, "mainVS", "vert"),
              SHADER_STAGE_TO_API_PAIR(TessellationControl, "mainTC", "tesc"),
              SHADER_STAGE_TO_API_PAIR(TessellatonEvaluate, "mainTE", "tese"),
              SHADER_STAGE_TO_API_PAIR(Geometry, "mainGeo", "geom"),
              SHADER_STAGE_TO_API_PAIR(Fragment, "mainFS", "frag") };
