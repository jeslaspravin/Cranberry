...
public:
    ...
    static VkCommandBuffer getRawCmdBuffer(
    ...
    static class VulkanDescriptorsSetAllocator *getDescriptorsSetAllocator(
    ...
    static VkSwapchainKHR createSwapchain(class IGraphicsInstance *graphicsInstance,
        const GenericWindowCanvas *windowCanvas, struct SwapchainInfo *swapchainInfo);
    static void fillSwapchainImages(class IGraphicsInstance *graphicsInstance, VkSwapchainKHR swapchain,
    ...
    static uint32 getNextSwapchainImage(class IGraphicsInstance *graphicsInstance,
        VkSwapchainKHR swapchain, SemaphoreRef *waitOnSemaphore, FenceRef *waitOnFence = nullptr);
    static void presentImage(class IGraphicsInstance *graphicsInstance,
    ...
    WindowCanvasRef createWindowCanvas(
        class IGraphicsInstance *graphicsInstance, GenericAppWindow *fromWindow) const final;
    void cacheSurfaceProperties(
        class IGraphicsInstance *graphicsInstance, const WindowCanvasRef &windowCanvas) const final;

    SemaphoreRef createSemaphore(
        class IGraphicsInstance *graphicsInstance, const TChar *semaphoreName) const;
    TimelineSemaphoreRef createTimelineSemaphore(
        class IGraphicsInstance *graphicsInstance, const TChar *semaphoreName) const;
    ...
    FenceRef createFence(class IGraphicsInstance *graphicsInstance, const TChar *fenceName,
        bool bIsSignaled = false) const;
    void waitFences(class IGraphicsInstance *graphicsInstance, std::vector<FenceRef> *fences,
        bool waitAll) const final;

    SamplerRef createSampler(
        class IGraphicsInstance *graphicsInstance, SamplerCreateInfo createInfo) const final;
    ESamplerFiltering::Type clampFiltering(class IGraphicsInstance *graphicsInstance,
        ESamplerFiltering::Type sampleFiltering, EPixelDataFormat::Type imageFormat) const final;

    static VkBuffer createBuffer(class IGraphicsInstance *graphicsInstance,
    ...
    // Normal data buffers
    BufferResourceRef createReadOnlyBuffer(class IGraphicsInstance *graphicsInstance,
        uint32 bufferStride, uint32 bufferCount = 1) const final;
    // Cannot be used as uniform
    BufferResourceRef createWriteOnlyBuffer(class IGraphicsInstance *graphicsInstance,
        uint32 bufferStride, uint32 bufferCount = 1) const final;
    // Can be used as both uniform and storage
    BufferResourceRef createReadWriteBuffer(class IGraphicsInstance *graphicsInstance,
        uint32 bufferStride, uint32 bufferCount = 1) const final;

    // Texels buffers
    BufferResourceRef createReadOnlyTexels(class IGraphicsInstance *graphicsInstance,
        EPixelDataFormat::Type texelFormat, uint32 bufferCount = 1) const final;
    // Cannot be used as uniform sampled
    BufferResourceRef createWriteOnlyTexels(class IGraphicsInstance *graphicsInstance,
        EPixelDataFormat::Type texelFormat, uint32 bufferCount = 1) const final;
    BufferResourceRef createReadWriteTexels(class IGraphicsInstance *graphicsInstance,
        EPixelDataFormat::Type texelFormat, uint32 bufferCount = 1) const final;

    // Other utility buffers
    BufferResourceRef createReadOnlyIndexBuffer(class IGraphicsInstance *graphicsInstance,
        uint32 bufferStride, uint32 bufferCount = 1) const final;
    BufferResourceRef createReadOnlyVertexBuffer(class IGraphicsInstance *graphicsInstance,
        uint32 bufferStride, uint32 bufferCount = 1) const final;

    BufferResourceRef createReadOnlyIndirectBuffer(class IGraphicsInstance *graphicsInstance,
        uint32 bufferStride, uint32 bufferCount = 1) const final;
    BufferResourceRef createWriteOnlyIndirectBuffer(class IGraphicsInstance *graphicsInstance,
        uint32 bufferStride, uint32 bufferCount = 1) const final;
    ...
    static bool allocateImageResource(class IGraphicsInstance *graphicsInstance,
        class IVulkanMemoryResources *memoryResource, bool cpuAccessible);
    static void deallocateImageResource(
        class IGraphicsInstance *graphicsInstance, class IVulkanMemoryResources *memoryResource);
    ...
    // Images
    ImageResourceRef createImage(class IGraphicsInstance *graphicsInstance,
        ImageResourceCreateInfo createInfo, bool bIsStaging = false) const final;
    ImageResourceRef createCubeImage(class IGraphicsInstance *graphicsInstance,
        ImageResourceCreateInfo createInfo, bool bIsStaging = false) const final;
    ImageResourceRef createRTImage(class IGraphicsInstance *graphicsInstance,
        ImageResourceCreateInfo createInfo,
        EPixelSampleCount::Type sampleCount = EPixelSampleCount::SampleCount1) const final;
    ImageResourceRef createCubeRTImage(class IGraphicsInstance *graphicsInstance,
        ImageResourceCreateInfo createInfo,
        EPixelSampleCount::Type sampleCount = EPixelSampleCount::SampleCount1) const final;
    ...
    void *borrowMappedPtr(
        class IGraphicsInstance *graphicsInstance, ImageResourceRef &resource) const final;
    void returnMappedPtr(
        class IGraphicsInstance *graphicsInstance, ImageResourceRef &resource) const final;
    void flushMappedPtr(class IGraphicsInstance *graphicsInstance,
        const std::vector<ImageResourceRef> &resources) const final;
    void *borrowMappedPtr(
        class IGraphicsInstance *graphicsInstance, BufferResourceRef &resource) const final;
    void returnMappedPtr(
        class IGraphicsInstance *graphicsInstance, BufferResourceRef &resource) const final;
    void flushMappedPtr(class IGraphicsInstance *graphicsInstance,
        const std::vector<BufferResourceRef> &resources) const final;

    void markForDeletion(class IGraphicsInstance *graphicsInstance, GraphicsResource *resource,
        EDeferredDelStrategy deleteStrategy, TickRep duration = 1) const final;
    ...
    static VkRenderPass createRenderPass(class IGraphicsInstance *graphicsInstance,
    ...
    static void createFramebuffer(class IGraphicsInstance *graphicsInstance,
    ...
    static VkDescriptorSetLayout createDescriptorsSetLayout(class IGraphicsInstance *graphicsInstance,
        const VkDescriptorSetLayoutCreateInfo &layoutCreateInfo);
    static VkDescriptorSetLayout getEmptyDescriptorsSetLayout(class IGraphicsInstance *graphicsInstance);
    static void destroyDescriptorsSetLayout(
        class IGraphicsInstance *graphicsInstance, VkDescriptorSetLayout descriptorsSetLayout);
    static void updateDescriptorsSet(class IGraphicsInstance *graphicsInstance,
    ...
    static VkPipelineCache createPipelineCache(
    ...
    static void destroyPipelineCache(
        class IGraphicsInstance *graphicsInstance, VkPipelineCache pipelineCache);
    static void mergePipelineCaches(class IGraphicsInstance *graphicsInstance, VkPipelineCache dstCache,
        const std::vector<VkPipelineCache> &srcCaches);
    static void getPipelineCacheData(class IGraphicsInstance *graphicsInstance,
        VkPipelineCache pipelineCache, std::vector<uint8> &cacheData);
    static void getMergedCacheData(class IGraphicsInstance *graphicsInstance,
        std::vector<uint8> &cacheData, const std::vector<const class PipelineBase *> &pipelines);

    // Pipelines
    PipelineBase *createGraphicsPipeline(
        class IGraphicsInstance *graphicsInstance, const PipelineBase *parent) const final;
    PipelineBase *createGraphicsPipeline(
        class IGraphicsInstance *graphicsInstance, const GraphicsPipelineConfig &config) const final;

    PipelineBase *createComputePipeline(
        class IGraphicsInstance *graphicsInstance, const PipelineBase *parent) const final;
    ...
    static std::vector<VkPipeline> createGraphicsPipeline(class IGraphicsInstance *graphicsInstance,
        const std::vector<VkGraphicsPipelineCreateInfo> &graphicsPipelineCI,
        VkPipelineCache pipelineCache);
    static std::vector<VkPipeline> createComputePipeline(class IGraphicsInstance *graphicsInstance,
        const std::vector<VkComputePipelineCreateInfo> &computePipelineCI,
        VkPipelineCache pipelineCache);
    ...
    ShaderParametersRef createShaderParameters(class IGraphicsInstance *graphicsInstance,
        const class GraphicsResource *paramLayout,
        const std::set<uint32> &ignoredSetIds = {}) const final;

    Framebuffer *createFbInstance() const final;
    void initializeFb(
        class IGraphicsInstance *graphicsInstance, Framebuffer *fb, const Size2D &frameSize) const final;
    void initializeSwapchainFb(class IGraphicsInstance *graphicsInstance, Framebuffer *fb,
        WindowCanvasRef canvas, uint32 swapchainIdx) const final;
