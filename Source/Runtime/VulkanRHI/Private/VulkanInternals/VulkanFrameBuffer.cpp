...
Framebuffer* VulkanGraphicsHelper::createFbInstance() const
{
...
void VulkanGraphicsHelper::initializeSwapchainFb(class IGraphicsInstance* graphicsInstance, Framebuffer* fb, WindowCanvasRef canvas, uint32 swapchainIdx) const
{
