...
#define IMAGE_VIEW_CREATE_INFO(VariableName)                                                            \
    ...
    VariableName.pNext = nullptr;                                                                       \
    VariableName.flags = 0;                                                                             \
    VariableName.components = { VkComponentSwizzle::VK_COMPONENT_SWIZZLE_IDENTITY,                      \
...
#define PIPELINE_RASTERIZATION_STATE_CREATE_INFO(VariableName)                                          \
    ...
    VariableName.depthBiasClamp = VariableName.depthBiasConstantFactor                                  \
...
#define DEFINE_TEMPLATED_VK_GRAPHICS_RESOURCE(                                                          \
    NewTypeName, NewTypeTemplates, TemplatesDefine, VkObjTypeName)                                      \
    template##NewTypeTemplates##VkObjectType NewTypeName##TemplatesDefine## ::getObjectType() const     \
    {                                                                                                   \
        return VkObjTypeName;                                                                           \
    }                                                                                                   \
                                                                                                        \
    template##NewTypeTemplates##String NewTypeName##TemplatesDefine## ::OBJ_TYPE_NAME                   \
        = TCHAR(#VkObjTypeName);                                                                        \
                                                                                                        \
    template##NewTypeTemplates##const String &NewTypeName##TemplatesDefine## ::getObjectTypeName()      \
        const                                                                                           \
    {                                                                                                   \
