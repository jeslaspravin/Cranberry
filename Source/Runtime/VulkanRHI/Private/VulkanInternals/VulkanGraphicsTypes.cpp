...
{
    // clang-format off
    static const std::pair<VkQueueFlagBits, VkPipelineStageFlags2> QUEUE_TO_PIPELINESTAGES[] = { 
...
{
    // clang-format off
    static const std::pair<VkQueueFlagBits, VkAccessFlags2> QUEUE_TO_ACCESSMASK[] = { 
