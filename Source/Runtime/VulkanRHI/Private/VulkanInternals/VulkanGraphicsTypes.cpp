...
#define MAKE_COMPS(...)
#define IMG_FORMAT_INFO_PAIR(PixelFormat,RelevantApiFormat,DataSize, ComponentSize, ...) { EPixelDataFormat::##PixelFormat, RelevantApiFormat }
...
#define SAMPLE_FILTER_INFO_PAIR(FilteringType,RelevantApiFormat, RelevantMipApiFormat) { RelevantApiFormat , RelevantMipApiFormat }
...
#define COMP_MAP_INFO_PAIR(ComponentMappingValue,RelevantApiFormat) { EPixelComponentMapping::##ComponentMappingValue, RelevantApiFormat }
